...
```bash
# 若没有配置文件，创建supervisor配置文件，注意先检查下有没有
...
- 1、在supervisord.conf 最后增加其他进程配置文件引入
...
- 2、在 /etc/supervisor/conf.d/ 目录下创建各子进程配置文件

/etc/supervisor/conf.d/v2.conf
...
有的操作系统好像是 *.ini 来，这个要注意。

### supervisorctl 配置文件说明
...
[![img](https://www.muouseo.com/storage/images/2022/01/25/YRNmRTaZD7c1w9Y0PlqTFvakWGy58JeGoeolJe2f.png)](https://www.muouseo.com/article/nq5vrkqe7p.html)
...
[![img](https://www.muouseo.com/storage/images/2022/01/25/Szajt9UOU6RDeO8gxuZKIzObOIiKV2EYuz5LFyBL.png)](https://www.muouseo.com/article/nq5vrkqe7p.html)
...
[![img](https://www.muouseo.com/storage/images/2022/01/13/A3CT8XnmI69N8BU9hh6rIrxEismApcPvFC93JwHH.png)](https://www.muouseo.com/article/nq5vrkqe7p.html)
